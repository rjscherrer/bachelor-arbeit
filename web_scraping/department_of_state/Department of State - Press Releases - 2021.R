...
page_version <- "2021"
main_url <- c("https://2017-2021.state.gov/press-releases/page/", "//index.html")
start_page <- 1
end_page <- 747
...
for(page_index in (start_page:end_page)) {
  if(page_index == 1) {
    html <- htmlParse(httr::content(GET("https://2017-2021.state.gov/press-releases//index.html"), as = "text", encoding = "UTF-8"), asText=T, encoding = "UTF-8")
  } else {
