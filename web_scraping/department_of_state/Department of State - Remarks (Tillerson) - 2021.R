...
article_category <- "remarks_tillerson"
page_version <- "2021"
main_url <- c("https://2017-2021.state.gov/remarks-former-secretary-of-state-tillerson/page/", "/index.html")
start_page <- 1
end_page <- 49
...
for(page_index in (start_page:end_page)) {
  if(page_index == 1) {
    html <- htmlParse(httr::content(GET("https://2017-2021.state.gov/remarks-former-secretary-of-state-tillerson/index.html"), as = "text", encoding = "UTF-8"), asText=T, encoding = "UTF-8")
  } else {
