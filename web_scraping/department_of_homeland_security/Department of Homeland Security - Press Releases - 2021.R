...
article_category <- "press_releases"
page_version <- "2021"
main_url <- "https://www.dhs.gov/archive/news-releases/press-releases?combine=&year_filter%5Bvalue%5D%5Byear%5D=&month_filter%5Bvalue%5D%5Bmonth%5D=&month_filter%5Bvalue%5D%5Byear%5D=&field_taxonomy_topics_tid=All&items_per_page=200&page="
start_page <- 0
end_page <- 10
